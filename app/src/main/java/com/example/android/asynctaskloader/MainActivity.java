...
public class MainActivity extends AppCompatActivity implements
    ...
    public Loader<String> onCreateLoader(int id, final Bundle args) {
        return new AsyncTaskLoader<String>(this) {
            ...
            // COMPLETE:TODO (1) Create a String member variable called mGithubJson that will store the raw JSON
               String mGithubJson;
            @Override
            protected void onStartLoading() {
                ...
                // COMPLETE:TODO (2) If mGithubJson is not null, deliver that result. Otherwise, force a load
                if(mGithubJson!=null)
                {
            ...
            //COMPLETE: TODO (3) Override deliverResult and store the data in mGithubJson
           //COMPLETE: TODO (4) Call super.deliverResult after storing the data
            @Override
